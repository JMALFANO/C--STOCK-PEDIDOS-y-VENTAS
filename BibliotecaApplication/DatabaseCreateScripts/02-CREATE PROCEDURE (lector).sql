...
IF EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND name = 'cliente_sel_max_id_lector')
DROP PROCEDURE cliente_sel_max_id_lector
GO
...
BEGIN
	INSERT INTO Cliente 
            (nombre, telefono, direccion, mail, cuit, horarios, comentarios, saldo) 
    VALUES 
            (@nombre, @telefono, @direccion, @mail, @cuit, @horarios, @comentarios, @saldo)
END
